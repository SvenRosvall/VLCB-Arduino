...
# 3.1.0 - Add functions for sending messages without sending node number.

While it is convenient for most uses to include the sending node number
there are many op-codes that do not include this node number.
